...
TODO mention that clouds are primary reason power goes down
...
The power plant starts producing power near sunrise, and reaches it's
...
that can provide the power as a cloud passes over the plant and turn
off quickly when the solar plant returns to normal operation.
