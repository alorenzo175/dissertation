...
requires a deep understanding of various error metrics and an
...
techniques]{Speculative root mean squared errors (RMSE) for various
  types of forecasts. This sketch serves as a hypothesis to be tested
  in this dissertation. We wish to understand the practical limitations
